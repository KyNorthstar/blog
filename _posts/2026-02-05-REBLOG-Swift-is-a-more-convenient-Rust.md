...
original:
    ...
    date: 2023-10-02
    author: Nmn
    author-url: https://nmn.sh
    
reblog-reason: >
    For awhile now, I've wanted to write a blog post about Rust, from the perspective of a seasoned Swift dev. I kept drafting it, but I could never quite present it in a way I'm happy with.
    
    Then I came across this blog post, which is about Swift, from the perspective of a seasoned Rust dev.
    
    I wanted to share this post on my blog because **I think it says a lot of things I've been thinking about for awhile, and says them very well**, along with perspectives I don't have and presentations I wouldn't think of.
    
    I might still write that post about Rust from my perspective as a Swift dev, but until then I think this post is a very valuable addition to this blog.

excerpt: 'From the Archive: Thoughts on Swift, while learning Rust'
---

_(originally published on my [old blog][OP])_
...
-   [Swift on Windows][Swift Everywhere: Using Interoperability to Build on Windows]
-   [Embedded Swift][Get Started with Embedded Swift on ARM and RISC-V Microcontrollers]
-   [Gnome apps with Swift on Linux][Writing GNOME Apps with Swift]
-   [Swift on Playdate][Byte-sized Swift: Building Tiny Games for the Playdate]

The browser company says that [Interoperability is Swift’s super power][Interoperability: Swift's Superpower].
...
{%- capture tweet-body %}
Writing Swift with VSCode just got much better.<br/>
\- Swift Testing ✅<br/>
\- Code coverage ✅<br/>
\- Refactoring improvements ✅<br/>
\- Easy version switching ✅<br/>
\- Code formatting ✅<br/>

All the details here: [forums.swift.org/t/improvements…](https://forums.swift.org/t/improvements-to-swift-in-visual-studio-code-coming-with-swift-6/72708) [@code](https://code.visualstudio.com)
{%- endcapture %}

{%- include tweet-embed.html
    body=tweet-body
    url="https://forums.swift.org/t/improvements-to-swift-in-visual-studio-code-coming-with-swift-6/72708"
    account-name="Swift Language"
...
Compile times are (like Rust) quite bad. There is some amount of feature creep and the language is larger than it should be. Not all syntax feels familiar. The [package ecosystem][Swift Package Index] isn’t nearly as rich as Rust.
...
[OP]: https://naman34.svbtle.com/swift-is-the-more-convenient-rust
...
[Interoperability: Swift's Superpower]: https://speakinginswift.substack.com/p/interoperability-swifts-super-power
